...
Prediction markets need a better end‑to‑end stack. We focus on the lifecycle: Market Creation → Market Trading → Market Settlement. Beyond the exchange, our goal is to build core InfoFi infrastructure: a decentralized prediction market exchange and an X bot that lets anyone tweet to create markets.
